...
from Functions.Functions_Regression_a import (LinReg_hyperparameter_tuning, Ridge_hyperparameter_tuning,
                                              final_model, multi_model_parameter_extraction, single_feature_extraction)
...
model_generalization_error, model_best_parameter, overall_avg_mse, y_pred_dict, y_test_outer_dict = Ridge_hyperparameter_tuning(
                            ...
                            KFold_value_outer = 10, KFold_value_inner = 10, random_state = 42,
                            continuous_cols=continuous_cols, onehot_cols=onehot_cols,
                            tuning_parameters = alphas, polynomial_degree = 1, solver='auto',
...
plot_actual_vs_pred(y_pred_dict, y_test_outer_dict, model_generalization_error, polynomial_degree=1)
